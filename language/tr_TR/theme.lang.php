...
$lang['If you find any issues, please report them to the'] = 'Eğer herhangi bir hata ile karşılaşırsanız lütfen raporlayın:';
$lang['HTML 5 canvas'] = 'HTML5 tuval';
$lang['Discover'] = 'Keşfet';
$lang['Disabled'] = 'Pasif';
$lang['Fullscreen'] = 'Tam ekran';
$lang['Grid view'] = 'Izgaralı görünüm';
...
$lang['A color theme from'] = 'Bir renk temasıp';
$lang['By'] = '.';
$lang['Description display style'] = 'Açıklama gösterim tarzı';
$lang['Components'] = 'Bileşenler';
$lang['Color theme'] = 'Renk teması';
$lang['Center mode'] = 'Ortalama modu';
$lang['Bug reports and feature requests'] = 'Hata raporları ve geliştirme istekleri';
...
$lang['Sidebar (like Boostrap Default)'] = 'Kenar çubuğu (Önyükleme Varsayılanı gibi)';
$lang['Display the currently selected image in the middle. Works best with infinite looping enabled.'] = 'Seçili görüntüyü ortada görüntüler. Sonsuz döngü etkinken en iyi şekilde çalışır.';
...
$lang['directly in the navigation bar'] = 'doğrudan gezinme çubuğunda';
$lang['center-aligned h5 heading'] = 'ortaya hizalanmış h5 başlığı';
$lang['Use full width containers that span the entire width of the viewport'] = 'Görünüm penceresinin tüm genişliği boyunca tam genişlikte kaplar kullanın';
$lang['Use 6 colums for viewports >= 1680px'] = 'Görünüm penceresi >= 1680px için 6 kolon kullanın';
$lang['Use description rather than title for images'] = 'Resimler için başlık yerine açıklama kullan';
$lang['Use colored share buttons instead of icons'] = 'Simgeler yerine renkli paylaşım düğmelerini kullan';
$lang['URL or releative path to the image'] = 'URL veya resmin relatif konumu';
$lang['from'] = '\'dan';
$lang['lazyLoad method'] = 'lazyLoad metodu';
$lang['milliseconds'] = 'milisaniye';
$lang['Issue tracker'] = 'Sorun takipçisi';
$lang['Enable the slick carousel below the main image on the picture page'] = 'Resim sayfasındaki ana görüntünün altında kaygan karuseli etkinleştirin';
$lang['Link thumbnail to'] = 'Küçük resmi bağlantıya ata';
$lang['Picture info display position'] = 'Resim bilgisi görüntüleme konumu';
$lang['Picture page display'] = 'Resim sayfası görüntüleme';
$lang['Show basic EXIF metadata'] = 'Temel EXIF metadata görüntüle';
$lang['Picture details page'] = 'Resim detayları sayfası';
$lang['Page header'] = 'Sayfa başlığı';
$lang['On mobile devices only'] = 'Sadece mobil cihazlarda';
$lang['Never'] = 'Asla';
$lang['List view'] = 'Liste görünümü';
$lang['Display a site logo image instead of plain text'] = 'Düz metin yerine bir logo görüntülensin';
$lang['AutoPlay'] = 'Otomatik oynatma';
$lang['Close (Esc)'] = 'Kapat (Esc)';
$lang['Next (arrow right)'] = 'Sonraki (sağ ok)';
$lang['Picture details'] = 'Resim ayrıntıları';
$lang['Previous (arrow left)'] = 'Önceki (sol ok)';
$lang['Share'] = 'Paylaş';
